...
const FIELD_LABELS: Record<string, Record<string, string>> = {
  vi: {
    ...
    hose_hnx_auto_refresh_enabled: "Tự động cập nhật HOSE/HNX",
    hose_hnx_refresh_time: "Giờ cập nhật HOSE/HNX",
    stock_batch_analysis_auto_enabled: "Tự động phân tích toàn bộ HOSE/HNX",
    stock_batch_analysis_time: "Giờ phân tích toàn bộ HOSE/HNX",
    ...
    trading_fee_pct_crypto: "Phí giao dịch crypto, khứ hồi (%)",
    ...
    stock_daily_price_limit_pct_hnx: "Biên độ giá trần/sàn 1 phiên - HNX (%)",
    stock_min_avg_value_vnd: "Giá trị giao dịch TB tối thiểu (VNĐ)",
  },
  en: {
    language: "Language",
    strategy: "Strategy",
    ...
    hose_hnx_auto_refresh_enabled: "HOSE/HNX Auto Refresh",
    hose_hnx_refresh_time: "HOSE/HNX Refresh Time",
    stock_batch_analysis_auto_enabled: "Full HOSE/HNX Batch Analysis",
    stock_batch_analysis_time: "Batch Analysis Run Time",
    ...
    trading_fee_pct_crypto: "Crypto Trading Fee, Round-trip (%)",
    ...
    stock_daily_price_limit_pct_hnx: "Daily Price-limit Band - HNX (%)",
    stock_min_avg_value_vnd: "Min Avg Daily Value (VND)",
  }
};
